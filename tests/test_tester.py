...
@pytest.mark.parametrize("cipher, plain, decode", [
    ("VGhpcyB0ZXN0IGlzIGEgc2ltcGxlIGJhc2U2NA==", "This test is a simple base64", "B"),
    ...
    ("FQrzmiL0JHX0SRFjJHWqnRnfSQv0JHTrnQvflxW6SQTrm2E2XMLrlwAqmw90WDK=", "This test uses two iterations: base64 and rot10", 'rB'),
...
def test_identify_decode_check(cipher, plain, decode, dictionary, search):
    if decode:
        candidates = define(decode, cipher)
